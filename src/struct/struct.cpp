...
void set_param_from_config_file(void)
{
  ...
  value = config_file->get_config_value("param", "sensor_cal1_pv");
  param.sensor_cal1_pv = std::stod(value);
  value = config_file->get_config_value("param", "sensor_cal2_pv");
  ...
  value = config_file->get_config_value("param", "low_alarm");
